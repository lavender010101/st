 ...
 */
// static char *font = "SauceCodePro Nerd
// Font:style=italic:pixelsize=18:antialias=true:autohint=true";
static char *font =
    "SauceCodePro Nerd "
    "Font:style=italic:pixelsize=20:antialias=true:autohint=true";
